...
CAMPOS: list[Campo] = [
    ...
    Campo("AMETISTA_VOZ", "pt-BR-FranciscaNeural", "Voz", "Voz pronta", tipo="voz_edge", atributo="VOZ",
          ajuda="Francisca: leve e clara (recomendada). Thalita: mais grave e muito natural; combine com um tom "
                "mais leve. Toque em Ouvir para comparar antes de salvar."),
    Campo("VOZ_VELOCIDADE", "-4%", "Voz", "Velocidade da voz pronta", tipo="opcao",
          opcoes=(("-10%", "Bem devagar"), ("-4%", "Calma e atenciosa (recomendada)"), ("+0%", "Normal"),
                  ("+5%", "Um pouco rápida"), ("+15%", "Rápida"))),
    Campo("VOZ_TOM", "+8Hz", "Voz", "Tom da voz pronta", tipo="opcao",
          opcoes=(("-6Hz", "Mais grave"), ("+0Hz", "O natural da voz"), ("+4Hz", "Um pouco mais leve"),
                  ("+8Hz", "Leve e acolhedora (recomendado)"), ("+12Hz", "Mais leve"), ("+16Hz", "Bem leve")),
          ajuda="Mais leve = um pouco mais fina, sem ficar infantil."),
