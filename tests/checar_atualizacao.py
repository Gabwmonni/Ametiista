"""Confere uma pasta que era a 1.0 e foi atualizada para a 2.0 (usado pelo GitHub Actions).
...
assert versao == "Ametista 2.0", versao

from ametista import autoinicio, config, identidade, memoria  # noqa: E402
...
print("OK: atualização da 1.0 para a 2.0 sem perder nada")
